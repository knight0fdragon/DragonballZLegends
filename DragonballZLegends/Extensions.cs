...
namespace DragonballZLegends
{
    public static class Extensions
    {
        ...
        public static void Push(this List<byte> stack, byte value) => stack.Add(value);
        public static byte Pop(this List<byte> stack)
        {
        ...
        public static byte[] ReadBytes(this Stream stream, int count, int? position = null)
        {
        ...
        public static byte[] ReadAllBytes(this Stream stream) => stream.ReadBytes((int)stream.Length, 0);
        ...
        public static void RenameEntry(this ZipArchive archive, string oldName, string newName)
        {
            ...
            newName = oldName.Replace(Path.GetFileName(oldName), newName);
            ZipArchiveEntry zipArchiveEntry = archive.CreateEntry(newName);
            ZipArchiveEntry zipArchiveEntry2 = archive.Entries.Where((ZipArchiveEntry w) => w.FullName == oldName).FirstOrDefault();
        ...
        public static byte[] ReadAllBytes(this ZipArchiveEntry archive)
        {
